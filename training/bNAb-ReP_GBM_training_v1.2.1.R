...
registerDoParallel( n.cores )
memory <- 320
path <- "/data1/rawir/Documents/work/vrc/projects/fast_projects/TatsianaBylund_MohammedElAnbari/bNAb-ReP2.0/data/bNAb-ReP/tmp/2F5/fold1/"
file.training.data <- "/data1/rawir/Documents/work/vrc/projects/fast_projects/TatsianaBylund_MohammedElAnbari/bNAb-ReP2.0/data/bNAb-ReP/tmp/2F5/fold1/Training_fold1_training_2F5_IC50_50.txt"
